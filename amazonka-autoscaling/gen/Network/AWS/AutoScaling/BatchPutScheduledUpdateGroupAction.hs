...
instance ToHeaders BatchPutScheduledUpdateGroupAction
         where
        toHeaders = const mempty

instance ToPath BatchPutScheduledUpdateGroupAction
         where
        toPath = const "/"

instance ToQuery BatchPutScheduledUpdateGroupAction
         where
        toQuery BatchPutScheduledUpdateGroupAction'{..}
          = mconcat
              ["Action" =:
                 ("BatchPutScheduledUpdateGroupAction" :: ByteString),
