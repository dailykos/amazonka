...
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/ASGettingNotifications.html Getting SNS Notifications When Your Auto Scaling Group Scales> in the /Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.PutNotificationConfiguration
    (
    -- * Creating a Request
...
--
-- * 'pncNotificationTypes' - The type of event that causes the notification to be sent. For more information about notification types supported by Amazon EC2 Auto Scaling, see 'DescribeAutoScalingNotificationTypes' .
putNotificationConfiguration
