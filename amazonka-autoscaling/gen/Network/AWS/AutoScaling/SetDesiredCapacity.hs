...
--
--
-- For more information about desired capacity, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/WhatIsAutoScaling.html What Is Amazon EC2 Auto Scaling?> in the /Amazon EC2 Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.SetDesiredCapacity
    (
    -- * Creating a Request
