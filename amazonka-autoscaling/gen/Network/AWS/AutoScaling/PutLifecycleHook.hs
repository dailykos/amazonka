...
--
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/lifecycle-hooks.html Auto Scaling Lifecycle Hooks> in the /Amazon EC2 Auto Scaling User Guide/ .
--
...
--
-- * 'plhNotificationMetadata' - Contains additional information that you want to include any time Amazon EC2 Auto Scaling sends a message to the notification target.
--
...
--
-- * 'plhLifecycleTransition' - The instance state to which you want to attach the lifecycle hook. The possible values are:     * autoscaling:EC2_INSTANCE_LAUNCHING     * autoscaling:EC2_INSTANCE_TERMINATING This parameter is required for new lifecycle hooks, but optional when updating existing hooks.
--
