...
--
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-termination.html#instance-protection Instance Protection> in the /Amazon EC2 Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.SetInstanceProtection
    (
    -- * Creating a Request
