...
--
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/schedule_time.html Scheduled Scaling> in the /Amazon EC2 Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.PutScheduledUpdateGroupAction
    (
    -- * Creating a Request
...
--
-- * 'psugaRecurrence' - The recurring schedule for this action, in Unix cron syntax format. For more information about this format, see <http://crontab.org Crontab> .
--
...
-- | The recurring schedule for this action, in Unix cron syntax format. For more information about this format, see <http://crontab.org Crontab> .
