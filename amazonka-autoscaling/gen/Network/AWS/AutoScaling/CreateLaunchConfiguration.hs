...
--
--
-- If you exceed your maximum limit of launch configurations, the call fails. For information about viewing this limit, see 'DescribeAccountLimits' . For information about updating this limit, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/as-account-limits.html Auto Scaling Limits> in the /Amazon EC2 Auto Scaling User Guide/ .
--
-- For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/LaunchConfiguration.html Launch Configurations> in the /Amazon EC2 Auto Scaling User Guide/ .
--
module Network.AWS.AutoScaling.CreateLaunchConfiguration
    (
    -- * Creating a Request
...
--
-- * 'clcPlacementTenancy' - The tenancy of the instance. An instance with a tenancy of @dedicated@ runs on single-tenant hardware and can only be launched into a VPC. To launch Dedicated Instances into a shared tenancy VPC (a VPC with the instance placement tenancy attribute set to @default@ ), you must set the value of this parameter to @dedicated@ . If you specify this parameter, be sure to specify at least one subnet when you create your group. For more information, see <http://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html Launching Auto Scaling Instances in a VPC> in the /Amazon EC2 Auto Scaling User Guide/ . Valid values: @default@ | @dedicated@ 
--
