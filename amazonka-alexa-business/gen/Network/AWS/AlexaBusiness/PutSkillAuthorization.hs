...
instance Hashable PutSkillAuthorization where

instance NFData PutSkillAuthorization where
...
putSkillAuthorizationResponse pResponseStatus_ =
  PutSkillAuthorizationResponse' {_psarsResponseStatus = pResponseStatus_}
...
instance NFData PutSkillAuthorizationResponse where
