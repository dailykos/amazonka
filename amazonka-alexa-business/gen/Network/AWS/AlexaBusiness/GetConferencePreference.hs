...
instance AWSRequest GetConferencePreference where
        type Rs GetConferencePreference =
             GetConferencePreferenceResponse
...
instance Hashable GetConferencePreference where

instance NFData GetConferencePreference where
...
data GetConferencePreferenceResponse = GetConferencePreferenceResponse'
  { _gcprsPreference :: !(Maybe ConferencePreference)
...
getConferencePreferenceResponse pResponseStatus_ =
  GetConferencePreferenceResponse'
    {_gcprsPreference = Nothing, _gcprsResponseStatus = pResponseStatus_}
...
instance NFData GetConferencePreferenceResponse where
