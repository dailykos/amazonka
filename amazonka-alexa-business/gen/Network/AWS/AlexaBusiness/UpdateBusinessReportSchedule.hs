...
data UpdateBusinessReportSchedule = UpdateBusinessReportSchedule'
  { _ubrsS3KeyPrefix :: !(Maybe Text)
  , _ubrsFormat :: !(Maybe BusinessReportFormat)
  , _ubrsRecurrence :: !(Maybe BusinessReportRecurrence)
  , _ubrsScheduleName :: !(Maybe Text)
  , _ubrsS3BucketName :: !(Maybe Text)
...
instance AWSRequest UpdateBusinessReportSchedule
         where
...
instance Hashable UpdateBusinessReportSchedule where

instance NFData UpdateBusinessReportSchedule where
...
updateBusinessReportScheduleResponse
    :: Int -- ^ 'ubrsrsResponseStatus'
    -> UpdateBusinessReportScheduleResponse
updateBusinessReportScheduleResponse pResponseStatus_ =
  UpdateBusinessReportScheduleResponse'
    {_ubrsrsResponseStatus = pResponseStatus_}
