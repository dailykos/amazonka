...
instance AWSPager ListSmartHomeAppliances where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lshaNextToken .~ rs ^. lsharsNextToken

instance AWSRequest ListSmartHomeAppliances where
        type Rs ListSmartHomeAppliances =
             ListSmartHomeAppliancesResponse
...
instance Hashable ListSmartHomeAppliances where

instance NFData ListSmartHomeAppliances where
...
data ListSmartHomeAppliancesResponse = ListSmartHomeAppliancesResponse'
  { _lsharsSmartHomeAppliances :: !(Maybe [SmartHomeAppliance])
  , _lsharsNextToken :: !(Maybe Text)
  , _lsharsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
listSmartHomeAppliancesResponse
    :: Int -- ^ 'lsharsResponseStatus'
    -> ListSmartHomeAppliancesResponse
listSmartHomeAppliancesResponse pResponseStatus_ =
  ListSmartHomeAppliancesResponse'
    { _lsharsSmartHomeAppliances = Nothing
...
instance NFData ListSmartHomeAppliancesResponse where
