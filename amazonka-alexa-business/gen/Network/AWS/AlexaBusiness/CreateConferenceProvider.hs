...
createConferenceProvider
    :: Text -- ^ 'ccpConferenceProviderName'
    -> ConferenceProviderType -- ^ 'ccpConferenceProviderType'
    -> MeetingSetting -- ^ 'ccpMeetingSetting'
    -> CreateConferenceProvider
createConferenceProvider pConferenceProviderName_ pConferenceProviderType_ pMeetingSetting_ =
  CreateConferenceProvider'
...
instance AWSRequest CreateConferenceProvider where
        type Rs CreateConferenceProvider =
             CreateConferenceProviderResponse
...
instance Hashable CreateConferenceProvider where

instance NFData CreateConferenceProvider where
...
data CreateConferenceProviderResponse = CreateConferenceProviderResponse'
  { _ccprsConferenceProviderARN :: !(Maybe Text)
...
createConferenceProviderResponse
    :: Int -- ^ 'ccprsResponseStatus'
    -> CreateConferenceProviderResponse
createConferenceProviderResponse pResponseStatus_ =
  CreateConferenceProviderResponse'
    { _ccprsConferenceProviderARN = Nothing
