...
data AssociateSkillWithUsers = AssociateSkillWithUsers'
  { _aswuOrganizationARN :: !(Maybe Text)
  , _aswuSkillId :: !Text
...
--
-- * 'aswuOrganizationARN' - The ARN of the organization.
--
...
associateSkillWithUsers pSkillId_ =
  AssociateSkillWithUsers'
    {_aswuOrganizationARN = Nothing, _aswuSkillId = pSkillId_}


-- | The ARN of the organization.
aswuOrganizationARN :: Lens' AssociateSkillWithUsers (Maybe Text)
aswuOrganizationARN = lens _aswuOrganizationARN (\ s a -> s{_aswuOrganizationARN = a})
...
instance ToJSON AssociateSkillWithUsers where
        toJSON AssociateSkillWithUsers'{..}
          = object
              (catMaybes
                 [("OrganizationArn" .=) <$> _aswuOrganizationARN,
                  Just ("SkillId" .= _aswuSkillId)])
