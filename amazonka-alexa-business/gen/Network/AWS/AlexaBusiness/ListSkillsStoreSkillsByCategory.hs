...
data ListSkillsStoreSkillsByCategory = ListSkillsStoreSkillsByCategory'
  { _lsssbcNextToken :: !(Maybe Text)
  , _lsssbcMaxResults :: !(Maybe Nat)
...
instance AWSPager ListSkillsStoreSkillsByCategory
         where
        page rq rs
          ...
          | otherwise =
            Just $ rq &
              lsssbcNextToken .~ rs ^. lsssbcrsNextToken

instance AWSRequest ListSkillsStoreSkillsByCategory
         where
...
instance NFData ListSkillsStoreSkillsByCategory where

instance ToHeaders ListSkillsStoreSkillsByCategory
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery ListSkillsStoreSkillsByCategory
         where
...
data ListSkillsStoreSkillsByCategoryResponse = ListSkillsStoreSkillsByCategoryResponse'
  { _lsssbcrsNextToken :: !(Maybe Text)
  , _lsssbcrsSkillsStoreSkills :: !(Maybe [SkillsStoreSkill])
  , _lsssbcrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
