...
newtype GetConferenceProvider = GetConferenceProvider'
  { _gcpConferenceProviderARN :: Text
...
getConferenceProvider
    :: Text -- ^ 'gcpConferenceProviderARN'
    -> GetConferenceProvider
getConferenceProvider pConferenceProviderARN_ =
  GetConferenceProvider' {_gcpConferenceProviderARN = pConferenceProviderARN_}
...
instance Hashable GetConferenceProvider where

instance NFData GetConferenceProvider where
...
data GetConferenceProviderResponse = GetConferenceProviderResponse'
  { _grsConferenceProvider :: !(Maybe ConferenceProvider)
...
getConferenceProviderResponse pResponseStatus_ =
  GetConferenceProviderResponse'
    {_grsConferenceProvider = Nothing, _grsResponseStatus = pResponseStatus_}
...
instance NFData GetConferenceProviderResponse where
