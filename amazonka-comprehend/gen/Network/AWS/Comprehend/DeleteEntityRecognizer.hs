...
instance AWSRequest DeleteEntityRecognizer where
        type Rs DeleteEntityRecognizer =
             DeleteEntityRecognizerResponse
...
instance Hashable DeleteEntityRecognizer where

instance NFData DeleteEntityRecognizer where
...
instance ToJSON DeleteEntityRecognizer where
        toJSON DeleteEntityRecognizer'{..}
          = object
              (catMaybes
                 [Just
                    ("EntityRecognizerArn" .= _derEntityRecognizerARN)])
...
instance NFData DeleteEntityRecognizerResponse where
