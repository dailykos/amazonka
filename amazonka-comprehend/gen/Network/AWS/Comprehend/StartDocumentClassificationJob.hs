...
data StartDocumentClassificationJob = StartDocumentClassificationJob'
  { _sdcjJobName :: !(Maybe Text)
  , _sdcjClientRequestToken :: !(Maybe Text)
  , _sdcjDocumentClassifierARN :: !Text
  , _sdcjInputDataConfig :: !InputDataConfig
  , _sdcjOutputDataConfig :: !OutputDataConfig
  , _sdcjDataAccessRoleARN :: !Text
...
startDocumentClassificationJob
    :: Text -- ^ 'sdcjDocumentClassifierARN'
    -> InputDataConfig -- ^ 'sdcjInputDataConfig'
    -> OutputDataConfig -- ^ 'sdcjOutputDataConfig'
    -> Text -- ^ 'sdcjDataAccessRoleARN'
    -> StartDocumentClassificationJob
startDocumentClassificationJob pDocumentClassifierARN_ pInputDataConfig_ pOutputDataConfig_ pDataAccessRoleARN_ =
  StartDocumentClassificationJob'
...
instance AWSRequest StartDocumentClassificationJob
         where
        type Rs StartDocumentClassificationJob =
             StartDocumentClassificationJobResponse
...
instance NFData StartDocumentClassificationJob where

instance ToHeaders StartDocumentClassificationJob
         where
        toHeaders
          = const
              (mconcat
...
data StartDocumentClassificationJobResponse = StartDocumentClassificationJobResponse'
  { _sdcjrsJobId :: !(Maybe Text)
  , _sdcjrsJobStatus :: !(Maybe JobStatus)
  , _sdcjrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
