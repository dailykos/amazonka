...
instance AWSPager ListDominantLanguageDetectionJobs
         where
        page rq rs
          ...
          | stop
            ...
            = Nothing
          | otherwise =
            Just $ rq & ldldjNextToken .~ rs ^. ldldjrsNextToken

instance AWSRequest ListDominantLanguageDetectionJobs
         where
...
instance ToHeaders ListDominantLanguageDetectionJobs
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON ListDominantLanguageDetectionJobs
         where
...
instance ToPath ListDominantLanguageDetectionJobs
         where
        toPath = const "/"

instance ToQuery ListDominantLanguageDetectionJobs
         where
