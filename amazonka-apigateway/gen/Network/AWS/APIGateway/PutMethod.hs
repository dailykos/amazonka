...
--
-- * 'putOperationName' - A human-friendly operation identifier for the method. For example, you can assign the @operationName@ of @ListPets@ for the @GET /pets@ method in <https://petstore-demo-endpoint.execute-api.com/petstore/pets PetStore> example.
--
