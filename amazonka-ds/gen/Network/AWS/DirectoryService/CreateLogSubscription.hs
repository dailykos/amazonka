...
--
-- * 'clsDirectoryId' - Identifier (ID) of the directory to which you want to subscribe and receive real-time logs to your specified CloudWatch log group.
--
...
instance Hashable CreateLogSubscription where

instance NFData CreateLogSubscription where
...
instance NFData CreateLogSubscriptionResponse where
