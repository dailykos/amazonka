...
--
-- For more information about adding a custom domain to your user pool, see <http://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-add-custom-domain.html Using Your Own Domain for the Hosted UI> .
--
module Network.AWS.CognitoIdentityProvider.UpdateUserPoolDomain
    (
    -- * Creating a Request
