...
data DescribeImportTasks = DescribeImportTasks'
  { _ditFilters :: !(Maybe [ImportTaskFilter])
...
describeImportTasks =
  DescribeImportTasks'
    {_ditFilters = Nothing, _ditNextToken = Nothing, _ditMaxResults = Nothing}
...
instance Hashable DescribeImportTasks where

instance NFData DescribeImportTasks where
...
instance NFData DescribeImportTasksResponse where
