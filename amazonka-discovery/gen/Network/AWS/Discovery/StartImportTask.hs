...
--
--
-- For more information, including step-by-step procedures, see <http://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-import.html Migration Hub Import> in the /AWS Application Discovery Service User Guide/ .
--
module Network.AWS.Discovery.StartImportTask
    (
    -- * Creating a Request
...
data StartImportTask = StartImportTask'
  { _sitClientRequestToken :: !(Maybe Text)
  , _sitName :: !Text
  , _sitImportURL :: !Text
...
instance Hashable StartImportTask where

instance NFData StartImportTask where
...
startImportTaskResponse
    :: Int -- ^ 'sitrsResponseStatus'
    -> StartImportTaskResponse
startImportTaskResponse pResponseStatus_ =
  StartImportTaskResponse'
    {_sitrsTask = Nothing, _sitrsResponseStatus = pResponseStatus_}
...
instance NFData StartImportTaskResponse where
