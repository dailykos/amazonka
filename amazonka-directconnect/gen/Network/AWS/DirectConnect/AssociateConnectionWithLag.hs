...
--
-- * 'acwlConnectionId' - The ID of the connection. For example, dxcon-abc123.
--
-- * 'acwlLagId' - The ID of the LAG with which to associate the connection. For example, dxlag-abc123.
associateConnectionWithLag
