...
--
-- For more information about AWS Auto Scaling, see the <http://docs.aws.amazon.com/autoscaling/plans/userguide/what-is-aws-auto-scaling.html AWS Auto Scaling User Guide> .
--
module Network.AWS.AutoScalingPlans
    (
