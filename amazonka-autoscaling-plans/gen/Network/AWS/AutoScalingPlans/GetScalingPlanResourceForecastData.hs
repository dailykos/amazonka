...
getScalingPlanResourceForecastData
    :: Text -- ^ 'gsprfdScalingPlanName'
    -> Integer -- ^ 'gsprfdScalingPlanVersion'
    -> ServiceNamespace -- ^ 'gsprfdServiceNamespace'
    -> Text -- ^ 'gsprfdResourceId'
    -> ScalableDimension -- ^ 'gsprfdScalableDimension'
    -> ForecastDataType -- ^ 'gsprfdForecastDataType'
...
instance ToHeaders GetScalingPlanResourceForecastData
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON GetScalingPlanResourceForecastData
         where
...
instance ToPath GetScalingPlanResourceForecastData
         where
        toPath = const "/"

instance ToQuery GetScalingPlanResourceForecastData
         where
