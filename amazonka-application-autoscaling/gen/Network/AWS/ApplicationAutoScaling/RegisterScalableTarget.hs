...
--
-- * 'rstMaxCapacity' - The maximum value to scale to in response to a scale out event. This parameter is required to register a scalable target.
--
-- * 'rstMinCapacity' - The minimum value to scale to in response to a scale in event. This parameter is required to register a scalable target.
--
-- * 'rstRoleARN' - Application Auto Scaling creates a service-linked role that grants it permissions to modify the scalable target on your behalf. For more information, see <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-service-linked-roles.html Service-Linked Roles for Application Auto Scaling> . For resources that are not supported using a service-linked role, this parameter is required and must specify the ARN of an IAM role that allows Application Auto Scaling to modify the scalable target on your behalf.
--
-- * 'rstServiceNamespace' - The namespace of the AWS service that provides the resource or @custom-resource@ for a resource provided by your own application or service. For more information, see <http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#genref-aws-service-namespaces AWS Service Namespaces> in the /Amazon Web Services General Reference/ .
--
