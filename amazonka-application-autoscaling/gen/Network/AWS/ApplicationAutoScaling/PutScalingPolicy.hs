...
-- | The policy type. This parameter is required if you are creating a scaling policy. For information on which services do not support @StepScaling@ or @TargetTrackingScaling@ , see <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html Step Scaling Policies for Application Auto Scaling> and <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html Target Tracking Scaling Policies for Application Auto Scaling> in the /Application Auto Scaling User Guide/ .
