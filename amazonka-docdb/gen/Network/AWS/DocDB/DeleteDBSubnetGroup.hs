...
--
-- * 'ddbsgDBSubnetGroupName' - The name of the database subnet group to delete. Constraints: Must match the name of an existing @DBSubnetGroup@ . Must not be default. Example: @mySubnetgroup@ 
deleteDBSubnetGroup
...
-- | The name of the database subnet group to delete. Constraints: Must match the name of an existing @DBSubnetGroup@ . Must not be default. Example: @mySubnetgroup@ 
