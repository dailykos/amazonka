...
--
-- * 'rdiForceFailover' - When @true@ , the reboot is conducted through a Multi-AZ failover.  Constraint: You can't specify @true@ if the instance is not configured for Multi-AZ.
--
