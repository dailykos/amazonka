...
instance ToJSON GetAggregateDiscoveredResourceCounts
         where
...
instance ToPath GetAggregateDiscoveredResourceCounts
         where
        toPath = const "/"

instance ToQuery GetAggregateDiscoveredResourceCounts
         where
