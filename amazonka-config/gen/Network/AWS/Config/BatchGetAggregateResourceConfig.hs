...
instance AWSRequest BatchGetAggregateResourceConfig
         where
...
instance NFData BatchGetAggregateResourceConfig where

instance ToHeaders BatchGetAggregateResourceConfig
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery BatchGetAggregateResourceConfig
         where
