...
data PutRetentionConfigurationResponse = PutRetentionConfigurationResponse'
  { _prcrsRetentionConfiguration :: !(Maybe RetentionConfiguration)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'prcrsRetentionConfiguration' - Returns a retention configuration object.
--
...
putRetentionConfigurationResponse pResponseStatus_ =
  PutRetentionConfigurationResponse'
    { _prcrsRetentionConfiguration = Nothing
    , _prcrsResponseStatus = pResponseStatus_
    }


-- | Returns a retention configuration object.
prcrsRetentionConfiguration :: Lens' PutRetentionConfigurationResponse (Maybe RetentionConfiguration)
prcrsRetentionConfiguration = lens _prcrsRetentionConfiguration (\ s a -> s{_prcrsRetentionConfiguration = a})

-- | -- | The response status code.
prcrsResponseStatus :: Lens' PutRetentionConfigurationResponse Int
