...
instance AWSRequest DeleteSourceCredentials where
        type Rs DeleteSourceCredentials =
             DeleteSourceCredentialsResponse
...
instance Hashable DeleteSourceCredentials where

instance NFData DeleteSourceCredentials where
...
instance NFData DeleteSourceCredentialsResponse where
