...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'searsStatus' - The status information returned for the search request.
--
-- * 'searsFacets' - The requested facet information.
--
-- * 'searsStats' - The requested field statistics information.
--
-- * 'searsHits' - The documents that match the search criteria.
--
