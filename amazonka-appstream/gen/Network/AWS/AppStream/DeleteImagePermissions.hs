...
instance AWSRequest DeleteImagePermissions where
        type Rs DeleteImagePermissions =
             DeleteImagePermissionsResponse
...
instance Hashable DeleteImagePermissions where

instance NFData DeleteImagePermissions where
...
instance NFData DeleteImagePermissionsResponse where
