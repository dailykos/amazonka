...
--
-- Returns information about a stack drift detection operation. A stack drift detection operation detects whether a stack's actual configuration differs, or has /drifted/ , from it's expected configuration, as defined in the stack template and any values specified as template parameters. A stack is considered to have drifted if one or more of its resources have drifted. For more information on stack and resource drift, see <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html Detecting Unregulated Configuration Changes to Stacks and Resources> .
--
--
...
newtype DescribeStackDriftDetectionStatus = DescribeStackDriftDetectionStatus'
  { _dsddsStackDriftDetectionId :: Text
...
describeStackDriftDetectionStatus
    :: Text -- ^ 'dsddsStackDriftDetectionId'
    -> DescribeStackDriftDetectionStatus
describeStackDriftDetectionStatus pStackDriftDetectionId_ =
  DescribeStackDriftDetectionStatus'
    {_dsddsStackDriftDetectionId = pStackDriftDetectionId_}
...
instance AWSRequest DescribeStackDriftDetectionStatus
         where
        type Rs DescribeStackDriftDetectionStatus =
             DescribeStackDriftDetectionStatusResponse
...
instance ToHeaders DescribeStackDriftDetectionStatus
         where
        toHeaders = const mempty

instance ToPath DescribeStackDriftDetectionStatus
         where
        toPath = const "/"

instance ToQuery DescribeStackDriftDetectionStatus
         where
...
data DescribeStackDriftDetectionStatusResponse = DescribeStackDriftDetectionStatusResponse'
  { _dsddsrsStackDriftStatus :: !(Maybe StackDriftStatus)
  , _dsddsrsDriftedStackResourceCount :: !(Maybe Int)
  , _dsddsrsDetectionStatusReason :: !(Maybe Text)
  , _dsddsrsResponseStatus :: !Int
  , _dsddsrsStackId :: !Text
  , _dsddsrsStackDriftDetectionId :: !Text
  , _dsddsrsDetectionStatus :: !StackDriftDetectionStatus
  , _dsddsrsTimestamp :: !ISO8601
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeStackDriftDetectionStatusResponse
    :: Int -- ^ 'dsddsrsResponseStatus'
    -> Text -- ^ 'dsddsrsStackId'
    -> Text -- ^ 'dsddsrsStackDriftDetectionId'
    -> StackDriftDetectionStatus -- ^ 'dsddsrsDetectionStatus'
    -> UTCTime -- ^ 'dsddsrsTimestamp'
    -> DescribeStackDriftDetectionStatusResponse
describeStackDriftDetectionStatusResponse pResponseStatus_ pStackId_ pStackDriftDetectionId_ pDetectionStatus_ pTimestamp_ =
  DescribeStackDriftDetectionStatusResponse'
    { _dsddsrsStackDriftStatus = Nothing
    ...
    , _dsddsrsStackDriftDetectionId = pStackDriftDetectionId_
