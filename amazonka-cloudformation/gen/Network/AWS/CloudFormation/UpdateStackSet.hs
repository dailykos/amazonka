        ...
        toQuery UpdateStackSet'{..}
          = mconcat
              ["Action" =: ("UpdateStackSet" :: ByteString),
               ...
               "Accounts" =:
                 toQuery (toQueryList "member" <$> _ussAccounts),
               "Regions" =:
                 toQuery (toQueryList "member" <$> _ussRegions),
               "Parameters" =:
